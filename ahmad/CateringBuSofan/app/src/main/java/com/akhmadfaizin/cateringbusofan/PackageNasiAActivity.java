...
public class PackageNasiAActivity extends AppCompatActivity {
    ...
    private class GetPackage extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String urld = "https://api.mlab.com/api/1/databases/cateringbusofan/collections/item?q={%22namaItem%22:%22Masakan%20Pelengkap%22}&apiKey=x12MbBjL_GcDU4cpE6VDnZ-Ghj3qvvMI";
        ...
        protected void onPostExecute(Void result) {
            ...
            btnProcess.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    PackageNasiASelect.setCollectionSelected(collectionSelected);
