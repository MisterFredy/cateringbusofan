...
public class PackageNasiBActivity extends AppCompatActivity {

    private String TAG = PackageNasiBActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_package_nasi_b);
    ...
    private class GetPackage extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PackageNasiBActivity.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (jsonStr != null) {
                try {
                    ...
                    // The Index Number 1 is for Nasi B
            ...
            // Fetching Image
            Picasso.with(PackageNasiBActivity.this)
            ...
            String urle = "https://api.mlab.com/api/1/databases/cateringbusofan/collections/item?q={%22namaItem%22:%22Pudding%22}&apiKey=x12MbBjL_GcDU4cpE6VDnZ-Ghj3qvvMI";
            String urlf = "https://api.mlab.com/api/1/databases/cateringbusofan/collections/item?q={%22namaItem%22:%22Air%20Mineral%20Box%22}&apiKey=x12MbBjL_GcDU4cpE6VDnZ-Ghj3qvvMI";
            String urlg = "https://api.mlab.com/api/1/databases/cateringbusofan/collections/item?q={%22namaItem%22:%22Kerupuk%20Box%22}&apiKey=x12MbBjL_GcDU4cpE6VDnZ-Ghj3qvvMI";
        ...
        protected void onPostExecute(Void result) {
            ...
            final PackageNoActionAdapter adapterA = new PackageNoActionAdapter(PackageNasiBActivity.this, listChoices.get(0));
            ...
            btnProcess.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    PackageNasiBSelect.setCollectionSelected(collectionSelected);
