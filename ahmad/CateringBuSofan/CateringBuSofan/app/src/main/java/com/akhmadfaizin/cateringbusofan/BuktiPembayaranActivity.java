...
public class BuktiPembayaranActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.bukti_pembayaran_menu, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_upload_bukti:
                Intent i = new Intent(this, UploadBuktiPembayaranActivity.class);
                i.putExtra("idpemesanan", parameter_id_pemesanan);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == 100){
            if(resultCode == RESULT_CANCELED){
                ...
                Intent i = new Intent(this, BuktiPembayaranActivity.class);
                i.putExtra("kodeTransaksi", parameter_id_pemesanan);
    ...
    private class GetPesanan extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String url = getString(R.string.base_url) + "buktibayarpesanan?status=1&id_pemesanan=" + parameter_id_pemesanan + "&sort=createdAt%20DESC";
        ...
        protected void onPostExecute(Void result) {
            ...
            if(buktiPembayaranItem.size() == 0) {
                ...
                final BuktiPembayaranAdapter adapter = new BuktiPembayaranAdapter(BuktiPembayaranActivity.this, buktiPembayaranItem, parameter_id_pemesanan, totalBayar, dp);
