...
public class PackageNasiDActivity extends AppCompatActivity {
    ...
    private class GetPackage extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PackageNasiDActivity.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (jsonStr != null) {
                try {
                    ...
                    // The Index Number 3 is for Nasi D
                    JSONObject jsonObjectPackage = jsonArray.getJSONObject(3);
        ...
        protected void onPostExecute(Void result) {
            ...
            final PackageNoActionAdapter adapterA = new PackageNoActionAdapter(PackageNasiDActivity.this, listChoices.get(0));
