...
public class PesananAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(!model.getUrlPhoto().equals("null")) {
        ...
        if(model.getApproval().equals("Sudah Disetujui")) {
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        ...
                        if(menuItem.getItemId() == R.id.detail) {
                            ...
                            i.putExtra("nama", model.getFullName());
                        ...
                        // Jika terpilih Ubah Approval
                        if(menuItem.getItemId() == R.id.approval) {
                            Intent i = new Intent(activity, PesananUbahApprovalActivity.class);
                            i.putExtra("kodeTransaksi", model.getKodeTransaksi());
                            i.putExtra("token", model.getToken());
